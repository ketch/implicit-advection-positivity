...
In what follows we assume $3\le m\in\nplus$. Consider the case of a 3-point centered difference \boxed{\text{SCHEME/APPROXIMATION?}} in space:
%\begin{align}
\[
...
Summarizing the above for any $m\ge 3$, $\te\in[0,1]$ and $\nu>0$, we have proved the following. 
