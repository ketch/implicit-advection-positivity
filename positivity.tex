...
\begin{align}
S := \frac{-\theta \nu^2}{m} \sum_{\ell=2}^m \frac{\lambda^2_\ell \cos(\xi_\ell)}{1+\theta^2\nu^2\lambda_\ell^2}
\end{align}
is also negative.  Since, for $2\le \ell \le m/2$,
\begin{align}
    \cos(\xi_\ell) & = -\cos(x_{\ell+m/2}) & \lambda_{\ell+m/2} & = \xi_\ell - \pi,
\end{align}
we can write
\begin{align}
    S & = \frac{-\theta \nu^2}{m} \left(\sum_{\ell=2}^{m/2} \frac{\lambda^2_\ell \cos(\xi_\ell)}{1+\theta^2\nu^2\lambda_\ell^2} + \sum_{\ell=m/2 + 1}^{m} \frac{\lambda^2_\ell \cos(\xi_\ell)}{1+\theta^2\nu^2\lambda_\ell^2} \right) \\
...
\end{align}
Since the factors $\cos(\xi_\ell)$ and $2\xi_\ell - \pi$ have the same sign as each
other for every $\ell$ in the range $2\le \ell \le m/2$, the last expression is
term-by-term negative.
