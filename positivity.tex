...
\subsection{Some useful sentences to reuse}
...
\boxed{\text{LL COMPLETE}} Due to the fact that the eigenvalues of the matrix $M$ in \eqref{Mdef} are known, we can use some necessary conditions... Perron--Frobenius theorem, $\lambda_1$ non-negative real dominant root. 
