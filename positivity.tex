...
These results are rather remarkable, since it is known that the underlying systems of ordinary differential equations obtained via any of the above-mentioned spatial semi-discretizations are \emph{not} positivity preserving. 
...
differences in space with the $\theta$-method in time.  
 Without using SSP theory \cite{SSPbook}, 
