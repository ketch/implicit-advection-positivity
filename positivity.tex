...
\begin{proof}
	...
	$k$, $\ell$ and $m$).
	Define the function {\color{red}{\boxed{\text{*** we need to explain what } \psi(x) \text{ means ***}}}}
	...
	yielding {\color{red}{\boxed{\text{*** misplaced () ***}}}}
...
{\color{red}{\boxed{\text{*** I think below here we should also assume for each $\ell$ that } \psi(\xi_\ell)\ne 0 \text{ ***}}}}
